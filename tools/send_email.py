...
SMTP_PORT = 587
SENDER_EMAIL = "pumanagoli@gmail.com"
SENDER_PASSWORD = "lvty avvx kchb xcwx"  # Use App Password for Gmail
...
def escalate_ticket_with_email(issue: str) -> dict:
    ...
    success = send_email(to_email="pumanagoli@gmail.com", subject=subject, body=body)
